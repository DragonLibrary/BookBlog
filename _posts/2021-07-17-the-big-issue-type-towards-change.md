...
Type in *The Big Issue* is not particularly captivating. The sans-serif typeface lacks contrast and flourish, yet has a slightly handwritten 'texture' to it. This provides a greater connection to the issues and emotions discussed than a blander or more technical font. Subtitles are an elongated version of the same font, interview questions in bold to differentiate them from the answers. Titles and headers change from article to article to add colour and interest to the page, as well as to indicate the